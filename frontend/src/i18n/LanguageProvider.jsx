...
const DICT = {
    uz: {
        ...
        germanSub: "Nemis tili darslari: video va materiallar",
        germanMaterials: "Materiallar",
        germanUploadFile: "Fayl yuklash",
        germanFileTitle: "Fayl nomi",
        germanFileDesc: "Tavsif (ixtiyoriy)",
        germanUploadBtn: "Yuklash",
        germanDownload: "Yuklab olish",
        germanMaterialUploaded: "Fayl muvaffaqiyatli yuklandi",
        germanMaterialError: "Fayl yuklashda xatolik",
        germanBackToLessons: "Darslarga qaytish",
        germanAddLesson: "Yangi dars qo'shish",
        germanLessonTitle: "Dars nomi (masalan: 1-dars: Salomlashish)",
        germanViews: "ko'rilgan",
        ...
        notifNewChat: "Yangi chat xabarlari",
    ...
    en: {
        ...
        germanSub: "German language lessons: videos and materials",
        germanMaterials: "Materials",
        germanUploadFile: "Upload file",
        germanFileTitle: "File name",
        germanFileDesc: "Description (optional)",
        germanUploadBtn: "Upload",
        germanDownload: "Download",
        germanMaterialUploaded: "File uploaded successfully",
        germanMaterialError: "Error uploading file",
        germanBackToLessons: "Back to lessons",
        germanAddLesson: "Add new lesson",
        germanLessonTitle: "Lesson name (e.g. Lesson 1: Greetings)",
        germanViews: "views",
        ...
        notifNewChat: "New chat messages",
    ...
    ru: {
        ...
        navGerman: "Немецкий язык",
        moreMenu: "Ещё",

        // Уроки (Growth / IELTS)
        growthSub: "Мотивация, саморазвитие и успех",
        ieltsSub: "Видеоуроки для подготовки к IELTS",
        germanSub: "Уроки немецкого языка: видео и материалы",
        germanMaterials: "Материалы",
        germanUploadFile: "Загрузить файл",
        germanFileTitle: "Название файла",
        germanFileDesc: "Описание (необязательно)",
        germanUploadBtn: "Загрузить",
        germanDownload: "Скачать",
        germanMaterialUploaded: "Файл успешно загружен",
        germanMaterialError: "Ошибка загрузки файла",
        germanBackToLessons: "Назад к урокам",
        germanAddLesson: "Добавить урок",
        germanLessonTitle: "Название урока (напр. Урок 1: Приветствие)",
        germanViews: "просмотров",
        ...
        notifNewChat: "Новые сообщения чата",
